...
use App\Http\Transformers\AssetModelLinksTransformer;
...
class AssetModelLinksController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $sort = in_array($request->input('sort'), $allowed_columns) ? $request->input('sort') : 'id'; // Todo: Figure out default sort column
        ...
        return (new AssetModelLinksTransformer)->transformAssetModelLinks($assetmodels, $total);
    }
