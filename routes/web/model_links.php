...
use App\Http\Controllers\AssetModelLinksController;
...
Route::group(['prefix' => 'model_links', 'middleware' => ['auth']], function () {
...
Route::resource('model_links', AssetModelLinksController::class, [
    'middleware' => [],
